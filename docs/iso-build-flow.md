...
- On Ubuntu 24.04, Colin OS also patches the installed `live-build` syslinux helper after dependency installation when that helper still hardcodes `/root/isolinux` instead of using its resolved bootloader source directory.
